<?php
	session_start();
	if (!isset($_GET['guser']) && count($_GET) == 0 ) {
		$_SESSION['guser'] = 'phillippohlandt';
	}
	else {
		$_SESSION['guser'] = $_GET['guser'];
	}
?>
...
<html>
<head>
	<title>gitshame.io bootstrap calendar</title>
	...
	<link rel="stylesheet" href="bootstrap/dist/css/bootstrap-responsive.css">
...
<div class="container">
	<div class="hero-unit">
		<h1>github contribution calendar for <?php echo $_SESSION['guser']; ?></h1>
	...
	<script type="text/javascript">
		var disqus_shortname = 'gitcontributionsbootstrapcalendar'; // required: replace example with your forum shortname
		(function() {
